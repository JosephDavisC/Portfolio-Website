    ...
    case 'bc-hacks-2024':
      return (
        <div className="prose max-w-none">
          ...
          <h3 className="text-2xl font-heading font-semibold text-espresso mb-4">Month 1: Initial Planning</h3>
          <p className="text-espresso/80 text-lg leading-relaxed mb-6">
          ...
          <h3 className="text-2xl font-heading font-semibold text-espresso mb-4">Month 2: Logistics & Budgeting</h3>
          <p className="text-espresso/80 text-lg leading-relaxed mb-6">
          ...
          <h3 className="text-2xl font-heading font-semibold text-espresso mb-4">Month 3: Outreach & Workshops</h3>
          <p className="text-espresso/80 text-lg leading-relaxed mb-6">
          ...
          <h3 className="text-2xl font-heading font-semibold text-espresso mb-4">Month 4: Preparation</h3>
          <p className="text-espresso/80 text-lg leading-relaxed mb-6">
          ...
          <h3 className="text-2xl font-heading font-semibold text-espresso mb-4">Month 5: Execution Prep</h3>
          <p className="text-espresso/80 text-lg leading-relaxed mb-6">
          ...
          <p className="text-espresso/80 text-lg leading-relaxed mb-6">
            <strong className="text-espresso">Day 2:</strong> Teams pitched their projects to a panel
          ...
          <ul className="text-espresso/80 text-lg leading-relaxed mb-6 list-disc list-inside space-y-2 ml-6">
    ...
    default:
      return (
        <div className="text-center py-20">
          <p className="text-espresso/60 text-xl font-mono">Article content coming soon...</p>
        </div>
      );
  }
};
      ...
      >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          {(article.externalLinks || article.externalLink) && (
            <div className="mt-12 card-brutal p-8">
              <h3 className="text-xl font-heading font-semibold text-espresso mb-4">Related Resources</h3>
